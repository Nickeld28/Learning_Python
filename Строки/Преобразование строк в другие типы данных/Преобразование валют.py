...
курс доллара и количество долларов, а затем выводит следующую фразу: «N долларов в рублях = M руб.»,
где N — это количество долларов, а M — количество рублей по текущему курсу.
...
print(str(amount) + " долларов в рублях = " + str(amount * curs) + " руб.")
