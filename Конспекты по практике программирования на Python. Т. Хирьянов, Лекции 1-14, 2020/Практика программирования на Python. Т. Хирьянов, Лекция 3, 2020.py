...
def foo_1(k: int, m: int) -> int:  # x и y это формальные параметры
    return k ** 2 + m
...
def foo_3(a, b, c=0):  # z - имеет значение по умолчанию
    return 100 * a + 10 * b + 1 * c


t = foo_3(1, 2, 3)
print(t)
print(foo_3(c=1, a=2, b=3))  # можно нарушить порядок параметров при явном указании - Именованные параметры
